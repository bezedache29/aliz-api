...
2. **Code review** — lancer `/code-review low` sur le diff committé — **sauf** si le message commence par `fix:` en réponse à une code review (inutile de re-reviewer les corrections)
